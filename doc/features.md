...
- Includes a rich [library of composable elements](user_guide/Annotating_Data) that can be overlaid, nested and positioned with ease.
- Supports [rapid data exploration](user_guide/Indexing_and_Selecting_Data) that naturally develops into a [fully reproducible workflow](user_guide/Exporting_and_Archiving).
...
- Rich semantics for [indexing and slicing of data in arbitrarily high-dimensional spaces](user_guide/Indexing_and_Selecting_Data).
- Plotting output using the [Matplotlib](user_guide/Plotting_with_Matplotlib), [Bokeh](user_guide/Plotting_with_Bokeh), and [plotly](https://plot.ly/) backends.
...
- All features [available in vanilla Python 2 or 3](user_guide/Applying_Customizations), with minimal dependencies.
...
- Provides [export and archival facilities](user_guide/Exporting_and_Archiving) for keeping track of your work throughout the lifetime of a project.

**Analysis and data access features**

- Allows you to annotate your data with dimensions, units, labels and data ranges.
- Easily [slice and access](user_guide/Indexing_and_Selecting_Data) regions of your data, no matter how high the dimensionality.
...
- Build [complex animations or interactive visualizations in seconds](user_guide/Live_Data) instead of hours or days.
...
- Support for fully interactive plots using the [Bokeh backend](user_guide/Plotting_with_Bokeh).
...
- [Automatic archival and export of notebooks](user_guide/Exporting_and_Archiving), including extracting figures as SVG, generating a static HTML copy of your results for reference, and storing your optional metadata like version control information.
