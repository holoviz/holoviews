...
[Dimensioned Containers](user_guide/Dimensioned_Containers) user guide
...
- Replace figures with lots of data with images prerendered
  by [datashade()](user_guide/Large_Data).
...
[Live Data](user_guide/Live_Data) rather than a HoloMap. The
...
object, see our [Composing Elements](user_guide/Composing_Elements)
user guide.
...
of an object, see our [Customizing Plots](user_guide/Customizing_Plots)
user guide.
