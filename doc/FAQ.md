...
[Dimensioned Containers](user_guide/Dimensioned_Containers.html) user guide
...
- Replace figures with lots of data with images prerendered
  by [datashade()](user_guide/Large_Data.html).
...
[Live Data](user_guide/Live_Data.html) rather than a HoloMap. The
...
object, see our [Composing Elements](user_guide/Composing_Elements.html)
user guide.
...
of an object, see our [Customizing Plots](user_guide/Customizing_Plots.html)
user guide.
