...
* A rich `library of composable elements <Tutorials/Elements>`_ that can be overlaid, nested and positioned with ease.
...
* Create complex animated or interactive visualizations with minimal code.
...
* Display of animated formats in the notebook or for export, including gif, webm, and mp4.
