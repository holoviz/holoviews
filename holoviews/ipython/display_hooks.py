...
from ..plotting import ANIMATION_OPTS, Render, opts, get_plot_size
...
def animate(anim, dpi, writer, mime_type, anim_kwargs, extra_args, tag):
    ...
    data = Render.anim_data(anim, mime_type, writer, dpi, **anim_kwargs)
...
def display_figure(fig, message=None, max_width='100%'):
    ...
    if backend == 'd3' and mpld3:
        ...
        figdata = Render.figure_data(fig, figure_format, dpi=dpi)
