...
class ElementPlot(BokehPlot, GenericElementPlot):
    ...
    def _title_properties(self, key, plot, element):
        ...
        if title_font != '12pt':
            title_font = title_font if bokeh_version > Version('2.2.3') else value(title_font)
    ...
    def _axis_properties(self, axis, key, plot, dimension=None,
        ...
        if ((axis == 'x' and self.xaxis in ['bottom-bare', 'top-bare', 'bare']) or
            ...
            zero_pt = '0pt' if bokeh_version > Version('2.2.3') else value('0pt')
            ...
            if ticksize:
                ticksize = ticksize if bokeh_version > Version('2.2.3') else value(ticksize)
    ...
    def _update_glyph(self, renderer, properties, mapping, glyph, source, data):
        ...
        legend_props = ('legend_field', 'legend_label') if bokeh_version >= Version('1.3.5') else ('legend',)
        ...
        if not cds_replace:
            ...
            with hold_policy(self.document, 'collect', server=server):
                ...
                event = ModelChangedEvent(self.document, source, 'data',
                                          ...
                                          setter='empty')
                if bokeh_version >= Version('2.4.0'):
