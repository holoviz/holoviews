    ...
    def _init_tools(self, element, callbacks=None):
        ...
        def _create_row(attr):
            ...
            if BOKEH_GE_3_7_0:
                ...
                if kind in "uifO":
                    ...
                    kwargs["formatter"] = CustomJS(args=dict(hover_model=hover_model, attr=attr), code="""
                    export default ({hover_model, attr}) => {
                      return hover_model.d[attr];
                    }; """)
                elif kind == "M":
            ...
            return (
                ...
                Span(children=[ValueOf(obj=hover_model, attr="d", **kwargs)], style={"text_align": "left"}),
            )
        ...
        def on_change(attr, old, new):
            ...
            with hold(self.document):
                hover_model.update(d={**data_coords, **data_vars})
