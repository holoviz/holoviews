...
class TablePlot(BokehPlot, GenericElementPlot):
    ...
    def __init__(self, element, plot=None, **params):
        ...
        element_ids = self.hmap.traverse(id, [Dataset, ItemTable])
    ...
    def get_data(self, element, ranges, style):
        return (
            {
                dimension_sanitizer(d.name): element.dimension_values(d)
    ...
    def initialize_plot(self, ranges=None, plot=None, plots=None, source=None):
        ...
        table = DataTable(
            source=source, columns=columns, height=self.height, width=self.width, **style
        )
    ...
    def _get_columns(self, element, data):
        ...
        for d in element.dimensions():
            ...
            if kind == "i":
                ...
                editor = StringEditor()
            column = TableColumn(
                field=dimension_sanitizer(d.name),
