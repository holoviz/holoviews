...
class HomogeneousColumnTests:
    ...
    def test_dataset_redim_hm_kdim(self):
        ...
        assert_data_equal(
            redimmed.dimension_values('Time'),
    ...
    def test_dataset_redim_hm_vdim(self):
        ...
        assert_data_equal(
            redimmed.dimension_values('Value'),
...
class HeterogeneousColumnTests(HomogeneousColumnTests):
    ...
    def test_dataset_groupby_dynamic(self):
        ...
        assert_element_equal(grouped_dataset['M'],
                         self.table.select(Gender='M').reindex(['Age']))
        assert_element_equal(grouped_dataset['F'],
...
class GriddedInterfaceTests:
    ...
    def test_select_slice_as_dimension_dict(self):
        ...
        assert_element_equal(self.dataset_grid.select({self.dataset_grid.kdims[1]: slice(0, 0.25)}), ds)
