...
class RadialHeatMapPlotTests(TestMPLPlot):
    def setup_method(self):
        ...
        self.wedge_data = [
            ((0.5, 0.5), 0.125, 0.375, 180.0, 360.0),
    ...
    def test_get_data(self):
        ...
        for wedge, wdata in zip(wedges, self.wedge_data, strict=True):
            assert (wedge.center, wedge.width, wedge.r, wedge.theta1, wedge.theta2) == wdata
    ...
    def test_get_data_xseparators(self):
        ...
        arrays = [
            np.array([[0.0, 0.25], [0.0, 0.5]]),
            np.array([[3.14159265, 0.25], [3.14159265, 0.5]]),
        ]
