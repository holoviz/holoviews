...
class TestBokehGraphPlot(TestBokehPlot):
    ...
    def test_graph_nodes_categorical_colormapped(self):
        ...
        self.assertEqual(field_to_dict(glyph.fill_color), {'field': 'Label', 'transform': cmapper})
    ...
    def test_graph_nodes_numerically_colormapped(self):
        ...
        self.assertEqual(field_to_dict(glyph.fill_color), {'field': 'Weight', 'transform': cmapper})
    ...
    def test_graph_edges_categorical_colormapped(self):
        ...
        self.assertEqual(field_to_dict(glyph.line_color), {'field': 'start_str__', 'transform': cmapper})
    ...
    def test_graph_edges_numerically_colormapped(self):
        ...
        self.assertEqual(field_to_dict(glyph.line_color), {'field': 'Weight', 'transform': cmapper})
    ...
    def test_graph_op_node_color(self):
        ...
        glyph = plot.handles['scatter_1_glyph']
        self.assertEqual(field_to_dict(glyph.fill_color), {'field': 'node_color'})
    ...
    def test_graph_op_node_color_linear(self):
        ...
        self.assertEqual(field_to_dict(glyph.fill_color), {'field': 'node_color', 'transform': cmapper})
        self.assertEqual(glyph.line_color, 'black')
    ...
    def test_graph_op_node_size(self):
        ...
        cds = plot.handles['scatter_1_source']
        glyph = plot.handles['scatter_1_glyph']
        self.assertEqual(field_to_dict(glyph.size), {'field': 'node_size'})
    ...
    def test_graph_op_node_alpha(self):
        ...
        cds = plot.handles['scatter_1_source']
        glyph = plot.handles['scatter_1_glyph']
        self.assertEqual(field_to_dict(glyph.fill_alpha), {'field': 'node_alpha'})
        self.assertEqual(field_to_dict(glyph.line_alpha), {'field': 'node_alpha'})
    ...
    def test_graph_op_node_line_width(self):
        ...
        cds = plot.handles['scatter_1_source']
        glyph = plot.handles['scatter_1_glyph']
        self.assertEqual(field_to_dict(glyph.line_width), {'field': 'node_line_width'})
    ...
    def test_graph_op_edge_color(self):
        ...
        glyph = plot.handles['multi_line_1_glyph']
        self.assertEqual(field_to_dict(glyph.line_color), {'field': 'edge_color'})
    ...
    def test_graph_op_edge_color_linear(self):
        ...
        self.assertEqual(field_to_dict(glyph.line_color), {'field': 'edge_color', 'transform': cmapper})
    ...
    def test_graph_op_edge_alpha(self):
        ...
        cds = plot.handles['multi_line_1_source']
        glyph = plot.handles['multi_line_1_glyph']
        self.assertEqual(field_to_dict(glyph.line_alpha), {'field': 'edge_alpha'})
    ...
    def test_graph_op_edge_line_width(self):
        ...
        cds = plot.handles['multi_line_1_source']
        glyph = plot.handles['multi_line_1_glyph']
        self.assertEqual(field_to_dict(glyph.line_width), {'field': 'edge_line_width'})
...
class TestBokehTriMeshPlot(TestBokehPlot):
    ...
    def test_trimesh_edges_categorical_colormapped(self):
        ...
        self.assertEqual(field_to_dict(glyph.line_color), {'field': 'node1_str__', 'transform': cmapper})
    ...
    def test_trimesh_op_edge_color_linear_filled(self):
        ...
        cmapper = plot.handles['edge_color_color_mapper']
        self.assertEqual(field_to_dict(glyph.fill_color), {'field': 'edge_color', 'transform': cmapper})
        self.assertEqual(glyph.line_color, 'black')
        self.assertEqual(cds.data['edge_color'], np.array([2.4, 3.6]))
        self.assertEqual(cmapper.low, 2.4)
        self.assertEqual(cmapper.high, 3.6)
...
class TestBokehChordPlot(TestBokehPlot):
    ...
    def test_chord_nodes_style_map_node_color_colormapped(self):
        ...
        self.assertEqual(arc_source.data['Label'], np.array(['A', 'B', 'C']))
        self.assertEqual(field_to_dict(glyph.fill_color), {'field': 'node_color', 'transform': cmapper})
        self.assertEqual(field_to_dict(arc_glyph.line_color), {'field': 'node_color', 'transform': cmapper})
