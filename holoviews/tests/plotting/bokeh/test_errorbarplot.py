...
class TestErrorBarsPlot(TestBokehPlot):
    ...
    def test_errorbars_padding_hard_range(self):
        errorbars = (
            hv.ErrorBars([(1, 1, 0.5), (2, 2, 0.5), (3, 3, 0.5)])
            .redim.range(y=(0, 4))
            .opts(padding=0.1)
        )
        plot = bokeh_renderer.get_plot(errorbars)
    ...
    def test_errorbars_color_op(self):
        errorbars = hv.ErrorBars(
            [(0, 0, 0.1, 0.2, "#000"), (0, 1, 0.2, 0.4, "#F00"), (0, 2, 0.6, 1.2, "#0F0")],
            vdims=["y", "perr", "nerr", "color"],
        ).opts(color="color")
        plot = bokeh_renderer.get_plot(errorbars)
    ...
    def test_errorbars_linear_color_op(self):
        errorbars = hv.ErrorBars(
            [(0, 0, 0.1, 0.2, 0), (0, 1, 0.2, 0.4, 1), (0, 2, 0.6, 1.2, 2)],
            vdims=["y", "perr", "nerr", "color"],
        ).opts(color="color")
        plot = bokeh_renderer.get_plot(errorbars)
        cds = plot.handles["cds"]
    ...
    def test_errorbars_categorical_color_op(self):
        errorbars = hv.ErrorBars(
            [(0, 0, 0.1, 0.2, "A"), (0, 1, 0.2, 0.4, "B"), (0, 2, 0.6, 1.2, "C")],
            vdims=["y", "perr", "nerr", "color"],
        ).opts(color="color")
        plot = bokeh_renderer.get_plot(errorbars)
        cds = plot.handles["cds"]
    ...
    def test_errorbars_alpha_op(self):
        errorbars = hv.ErrorBars(
            [(0, 0, 0.1, 0.2, 0), (0, 1, 0.2, 0.4, 0.2), (0, 2, 0.6, 1.2, 0.7)],
            vdims=["y", "perr", "nerr", "alpha"],
        ).opts(alpha="alpha")
        plot = bokeh_renderer.get_plot(errorbars)
        cds = plot.handles["cds"]
        glyph = plot.handles["glyph"]
    ...
    def test_errorbars_line_width_op(self):
        errorbars = hv.ErrorBars(
            [(0, 0, 0.1, 0.2, 1), (0, 1, 0.2, 0.4, 4), (0, 2, 0.6, 1.2, 8)],
