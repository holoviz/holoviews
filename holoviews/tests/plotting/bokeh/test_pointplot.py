...
class TestPointPlot(TestBokehPlot):
    ...
    def test_point_categorical_color_op_legend_with_labels(self):
        ...
        assert field_to_dict(legend.label) == {'field': '_color_labels'}
    ...
    def test_point_explicit_cmap_color_op(self):
        ...
        self.assertEqual(field_to_dict(glyph.fill_color), {'field': 'color_str__', 'transform': cmapper})
        self.assertEqual(field_to_dict(glyph.line_color), {'field': 'color_str__', 'transform': cmapper})
    ...
    def test_point_size_op(self):
        ...
        self.assertEqual(field_to_dict(glyph.size), {'field': 'size'})
    ...
    def test_point_marker_op(self):
        ...
        self.assertEqual(field_to_dict(glyph.marker), {'field': 'marker'})
    ...
    def test_point_color_index_color_no_clash(self):
        ...
        self.assertEqual(field_to_dict(glyph.fill_color), {'field': 'fill_color', 'transform': cmapper})
        self.assertEqual(field_to_dict(glyph.line_color), {'field': 'color', 'transform': cmapper2})
