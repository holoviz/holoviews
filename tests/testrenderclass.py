...
from holoviews.plotting import Render
...
Render.capture_mode = 1 # Use mode 2 to see the saved files, 1 otherwise (capture only)


@attr(optional=1)
class RenderTest(ComparisonTestCase):
    """
